...
function TeacherDashboard() {
  ...
  useEffect(() => {
    ...
    fetch(import.meta.env.VITE_API_URL + '/api/teacher/my-status', {
  ...
  const loadMyCourses = async () => {
    try {
      const res = await fetch(import.meta.env.VITE_API_URL + '/api/teacher/all-courses')
  ...
  const handleVideoUpload = async (index, file) => {
    ...
    try {
      ...
      const data = await res.json()
      if (res.ok) {
        updateLesson(index, 'video', `${import.meta.env.VITE_API_URL}/uploads/${data.filename}`)
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch(import.meta.env.VITE_API_URL + '/api/teacher/save-course', {
        method: 'POST',
        headers: {
      ...
      if (res.ok) {
        ...
        const allRes = await fetch(import.meta.env.VITE_API_URL + '/api/teacher/all-courses')
